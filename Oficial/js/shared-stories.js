...
// Função para definir cookie (se não existir globalmente)
        ...
        <div style="display: flex; flex-direction: column; align-items: center; gap: 4px;">
            ...
            <div style="position: absolute; top: -30px; left: 50%; transform: translateX(-50%); z-index: 30;">
                <div style="background-color: rgb(43, 48, 54); padding: 6px 10px; border-radius: 12px; box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 6px; max-width: 90px; text-align: center;">
                    <span style="font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Helvetica, Arial, sans-serif; font-size: 11px; color: rgb(255, 255, 255); line-height: 1.2; display: block; ${userLabelBlur}">${userLabel}</span>
                </div>
            </div>
            ` : ''}
    ...
    const storiesHTML = orderedStories.map((user, index) => {
        ...
        return `
            <div style="display: flex; flex-direction: column; align-items: center; gap: 4px;">
                ...
                <div style="position: absolute; top: -30px; left: 50%; transform: translateX(-50%); z-index: 30;">
                    <div style="background-color: rgb(43, 48, 54); padding: 6px 10px; border-radius: 12px; box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 6px; max-width: 90px; text-align: center;">
                        <span style="font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Helvetica, Arial, sans-serif; font-size: 11px; color: rgb(255, 255, 255); line-height: 1.2; display: block; ${labelBlur}">${label}</span>
                    </div>
                </div>
                ` : ''}
                <button class="story-button">
